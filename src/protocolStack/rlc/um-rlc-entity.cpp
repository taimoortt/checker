        ...
        if ((packet->GetRLCHeader()->IsAFragment() &&
          ...
          if (tags->GetApplicationType() ==
            ...
            if (tags->GetFrameNumber() < 7) {
              ...
              // Do not terminate the simulator when this diagnostic sample is
              // complete. Artifact campaigns must run for the duration passed
              // on the command line so throughput windows remain comparable.
            }
